...
export default function App() {
  return (
    <View style={styles.container}>
      ...
      O Corinthians é o grande campeão do Paulistão 2025, conquistando o 31º título estadual de sua história! Sob o comando do técnico Ramón Díaz, o Timão superou o rival Varmeiras em uma final emocionante e levantou mais uma taça para sua gloriosa galeria.
      ' />
